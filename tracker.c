...
/*   Updated: 2025/12/09 17:56:03 by nismayil         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
bool	philo_died(t_philo *philo)
{
	...
	elapsed = get_time(MILLISECOND) - get_long(&philo->philo_lock,
			&philo->born_last_ate);
...
void	*track(void *arg)
{
	...
	props = (t_props *)arg;
	while (!all_threads_running(&props->props_lock, &props->n_threads_running,
